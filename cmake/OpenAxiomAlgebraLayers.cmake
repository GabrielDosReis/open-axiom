...
set(oa_algebra_layer_2
  ...
  DFSFUN DHMATRIX DIRPROD DSMP EXITAST FAGROUP FAMONOID FAXF
  FILE FRAC FRIDEAL FSAGG2 FUNDESC GALUTIL GAUSSFAC GDMP
  GHENSEL GMODPOL HASAST IALGFACT IDPOAMS IFAST IMATQF IMPTAST
  INAST INBCON INEP INFORM1 INMODGCD INNMFACT INTFACT IPADIC
  IR IRFORM ISAST ISUMP ITUPLE JOINAST JVMCFACC JVMFDACC
  JVMMDACC JVMOP KAFILE LETAST LIMITRF LINELT LITERAL LSTAST
  MAPPAST MCDEN MDDFACT MKFLCFN MONOPC MPOLY MRATFAC MSET
  MULTSQFR NAALG NASRING NORMMA NSUP2 NUMERIC OCT ODEPRIM
  ODERED ODESYS ODETOOLS OFMONOID OMSAGG OPSIG ORESUP OUT
  OUTBCON PARAMAST PATMATCH PATTERN1 PFOTOOLS PFRPAC PGCD PINTERP
  PMDOWN PNTHEORY POLY POLY2UP PREASSOC PROPFUN2 PRTDAST PTFUNC2
  PTPACK QQUTAST QUEUE RADIX RDUCEAST REALSOLV RECLOS REDORDER
  RESRING RETAST RMATCAT RPTAST RSTRCAST SASTCAT SEGAST SEGBIND2
  SEQAST SET SGPOP SHP SIGAST SPADAST SPADXPT STEPAST
  STREAM1 STREAM2 STREAM3 SUBSPACE SUCHTAST SYMTAB TABLBUMP TUBE
  TYPEAST UNISEG UNISEG2 UP2 UPOLYC UTS2 UTSODETL VIEWDEF
  WHEREAST WHILEAST XPR YSTREAM
)
...
set(oa_algebra_layer_4
  ...
  ELFUTS ENV EXPRTUBE EXPUPXS FFP FFPOLY2 FPARFRAC FRMOD
  FRNAALG FS2 FSPECF FSRED GPOLSET HDMP IBACHIN IBATOOL
  IDECOMP INTRAT INTTOOLS INVLAPLA IOBFILE ITAYLOR LF LODO
  LWORD MACROAST MATRIX MRF2 NETCLT NUMTUBE OP OPQUERY
  PADEPAC PADICRAT PAN2EXPR PF PICOERCE PMASSFS PMFS PMPLCAT
  PMPREDFS PRTITION SGCF SQMATRIX STTF SUMRF SUTS TOOLSIGN
  TOPSP TSETCAT UTSODE XPOLYC
)
...
set(oa_algebra_layer_5
  ...
  EFSTRUC EFULS ELABOR EXPR EXPR2 EXPRODE FF FFF
  FFHOM FFINTBAS FFX FRNAAF2 FSUPFACT GALFACT GENUFACT GTSET
  IAN INETCLTS INPRODFF INTRF ITRIGMNP JORDAN LGROBP LIE
  LODO1 LODO2 NCEP NFINTBAS PBWLB PERM PERMAN PLEQN
  PMASS PMPRED POLTOPOL QALGSET2 QFORM RULE SMTS STINPROD
  STTFNC SYMPOLY UPXSSING WFFINTBS XDPOLY XEXPPKG YDIAGRAM
)
...
set(oa_algebra_layer_6
  ...
  DROPT0 EVALCYC EXPEXPAN FFCGP FFNBP FGLMICPK FLOATCP FS2UPS
  GCNAALG GROEBSOL IFF INFPROD0 INPRODPF IR2F IRSN LSQM
  MULTFACT NREP ODERAT PERMGRP PGROEB PSETPK PWFFINTB REP1
  RULESET SULS SUMFS TRIGMNIP TRMANIP TS TWOFACT UTSCAT
  XRPOLY
)
