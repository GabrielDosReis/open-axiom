...
function handleResponse() {
	...
	if (http_request.status == 200) {
	    var mathString = http_request.responseText;
            alert('handleResponse: '+mathString);
...
function makeCompCell(mathString) {
    ...
    compCell.appendChild(vspace);
    //
    var testBox = document.createElement('description');
    testBox.setAttribute('value','Hello World');
    ansBox.appendChild(testBox);
    //
    alert('makeCompCell end');
}
