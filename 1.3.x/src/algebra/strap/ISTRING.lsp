...
(DEFUN |ISTRING;replace;$Us2$;15| (|s| |sg| |t| $)
  (PROG (|l| |m| |n| |h| #0=#:G1437 |r| #1=#:G1533 #2=#:G1534 |i|
             #3=#:G1535 |k|)
    (RETURN
      (SEQ (LETT |l|
...
(DEFUN |ISTRING;substring?;2$IB;17| (|part| |whole| |startpos| $)
  (PROG (|np| |nw| |iw| |ip| #0=#:G1536 #1=#:G1451 #2=#:G1447)
    (RETURN
...
(DEFUN |ISTRING;concat;L$;28| (|l| $)
  (PROG (#0=#:G1541 #1=#:G1496 #2=#:G1494 #3=#:G1495 |t| |s| #4=#:G1542
            |i|)
    (RETURN
      (SEQ (LETT |t|
                 (MAKE-FULL-CVEC
...
(DEFUN |ISTRING;match?;2$CB;34| (|pattern| |target| |dontcare| $)
  (PROG (|n| |m| #0=#:G1513 #1=#:G1516 |s| #2=#:G1517 #3=#:G1526 |i|
             |p| #4=#:G1518 |q|)
    (RETURN
      (SEQ (EXIT (SEQ (LETT |n|
